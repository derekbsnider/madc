...
if [ "$_cur_branch" = "feature/header-partition-claude" ]; then
  ...
  echo "  GREEN TIP = 28f7d4d (fulltest 543/4; cout+ofstream realhdr OK). 29 commits ahead, UNPUSHED."
  ...
  echo "  That WIP lives on branch feature/cpp-detection-idiom-claude (off 28f7d4d) — NOT on the green"
