...
static int v32_integer_vector_type_p (c2m_ctx_t c2m_ctx, struct type *type) {
  return type->mode == TM_VECTOR && raw_type_size (c2m_ctx, type) == 4
         && integer_type_p (type->u.vector_type->el_type);
}
