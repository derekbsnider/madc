// Exploratory storage/federation runtime support:
// - Query / QueryBuilder skeleton
// - DataDriverRegistry
// - built-in dsv:// driver
...
DataDriverRegistry::DataDriverRegistry()
    : _(new impl())
{
    register_factory("dsv", std::unique_ptr<Factory>(new DsvDriverFactory()));
    register_factory("flr", std::unique_ptr<Factory>(new FlrDriverFactory()));
    register_factory("vlr", std::unique_ptr<Factory>(new VlrDriverFactory()));
    register_optional_storage_drivers(*this);
}

DataDriverRegistry &DataDriverRegistry::instance()
{
    static DataDriverRegistry reg;
    return reg;
}
