/* aarch64_char_sign.c — plain char is UNSIGNED on aarch64-linux; signed char
   ...
   _Generic's controlling expression is lvalue-converted only (C11 6.5.1.1p2):
   c2mir integer-promoted it, so every char-family operand selected default. */
