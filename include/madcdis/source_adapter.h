#ifndef __MADCDIS_SOURCE_ADAPTER_H
#define __MADCDIS_SOURCE_ADAPTER_H 1
...
{
public:
	virtual ~StreamingSourceAdapter() {}
	virtual std::unique_ptr<Cursor<ExtractedRecord> > extract_stream(
...
#endif // __MADCDIS_SOURCE_ADAPTER_H
