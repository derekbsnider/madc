#ifndef __LIBMADCDAT_MAPPER_SHIM_H
#define __LIBMADCDAT_MAPPER_SHIM_H 1

// TRANSITIONAL forwarding shim (task #58 / plan C1): the mapper interface
...
// "madcdis/mapper.h" directly. Deletion horizon: the first release after
// external drivers (libmadcdat) ship against the madcdis paths.

#include "madcdis/mapper.h"

#endif // __LIBMADCDAT_MAPPER_SHIM_H
