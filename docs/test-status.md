...
- Failing: none
- Timed out: none
- Unit tests: all passing (doctest, core-only `--enable-madcdat=no` workspace) — 80 datadef + 23 IR + 95 libmadc_program + 5 libmadc_error + 19 libmadc_value (222 total)
