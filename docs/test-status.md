...
Test results as of May 1, 2026 (post-v0.13.0 plus first-wave C23 compatibility: `_Static_assert`, `alignof`, `typeof`, `nullptr`, digit separators).
...
- Failing: none
- Timed out: none
- Unit tests: all passing (doctest) — 77 datadef + 23 IR + 19 libmadc_value
