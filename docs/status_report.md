...
This file is a historical snapshot and is no longer maintained as a live
status source.
...
If you need to refresh project state, read `docs/agent-handoff.md` and
follow its read order instead of extending this file.
