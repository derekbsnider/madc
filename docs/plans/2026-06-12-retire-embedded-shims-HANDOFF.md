...
The last CODE commit is **`a12314b`** (binary built from it) — **Stage 0 DONE** (array→ptr decay) and
**Stage 1 PART 1 DONE** (reference-to-pointer return value typing in deduction), both all-4-gates green, zero
regressions.
