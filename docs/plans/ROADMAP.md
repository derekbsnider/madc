...
| 2.12 | **C++11 conformance measured by a third-party suite** — gcc's g++ testsuite (`g++.dg` cpp0x+template compile-clean, `--std=c++11`) driven by the gcc-torture runner, ratcheted against a baseline | first measurement DONE | **1369/1950 in-scope (70.2%) at 2026-09-18**, baseline 624, 0 outside baseline, 0 runtime failures (was 1169/60% on 2026-09-17). Ratchet `scripts/gxx_lane.sh` + `docs/parity/gxx-c++11-baseline.txt`, ledger row `gxx-c++11` promote=no — a ROADMAP GOAL, never a push or release gate (owner ruling). 🎯 **OWNER TARGET 2026-09-18: cut a MASTER RELEASE at 75%** = 1463/1950, i.e. +94 from here; 75% is the TRIGGER, not the release (the release-tier lanes, the gcc-torture promote gate and the owner's own call still apply). ⚠⚠ OWNER PIVOT 2026-09-17: the lane's FIRST job is to be the self-host arc's REDUCER SOURCE. Current families of 579 failures: **115 integer-constant-expression** (blocked on constexpr CONSTRUCTOR evaluation — aggregates fold since 2026-09-18, ctor-initialized objects do NOT; cpp0x/constexpr-delegating.C is canonical), 46 undeclared identifier, 31 template-parameter-list, **24 static assertion failed of which 11 are SFINAE** (newly visible after `2d0a215d1` made 19 empty diagnostics legible — these are WRONG ANSWERS, not parse refusals), 15 identifier-after-type. ⚠ Family counting MUST normalize quoted text or a family splits into singletons. Cross-standard (`--gxx-dirs`, d61af6f42): C++14 196/417 47.0%, C++17 118/308 38.3%, C++20 336/653 51.5%, **cumulative C++17 1679/2675 = 62.8%**; CTAD is 33% of C++17 failures — design settled in [2026-09-18-ctad-implementation.md](2026-09-18-ctad-implementation.md), NOT on the C++11 path | [2026-09-04-cxx-conformance-lane.md](2026-09-04-cxx-conformance-lane.md) |
