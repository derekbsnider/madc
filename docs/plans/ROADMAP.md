...
| 1.3 | **CIR coverage — drive `cir_node` (MC11-IR) → c2mir → MIR to full parity** | ongoing | **Active — the parity-to-master gate** (543 pass / 4 fail / 0 timeout / 26 skip on 2026-06-09; known reds: `testdefer`, `testfstream`, `testlargesizeofquery`, `testloop`; gcc-torture 1566/1685 = 92.9% vs asmjit 97.6%) | — |
