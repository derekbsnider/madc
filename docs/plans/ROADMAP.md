...
- **CIR baseline (2026-06-02):** **451 integration pass / 12 fail / 55 skip**;
  **gcc.c-torture 1556/1685 (92.3%)** vs the old asmjit backend's 1645 (97.6%) — gap 89.
...
| 1.3 | **CIR coverage — drive `cir_node` (MC11-IR) → c2mir → MIR to full parity** | ongoing | **Active — the parity-to-master gate** (451 pass / 12 fail / 55 skip; gcc-torture 1556/1685 = 92.3% vs asmjit 97.6%) | — |
