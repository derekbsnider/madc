...
- **CIR baseline (2026-06-02):** **452 integration pass / 11 fail / 55 skip**;
  **gcc.c-torture 1561/1685 (92.6%)** vs the old asmjit backend's 1645 (97.6%) — gap 84.
...
| 1.3 | **CIR coverage — drive `cir_node` (MC11-IR) → c2mir → MIR to full parity** | ongoing | **Active — the parity-to-master gate** (452 pass / 11 fail / 55 skip; gcc-torture 1561/1685 = 92.6% vs asmjit 97.6%) | — |
