...
- **CIR baseline (2026-06-09 late):** **546 integration/unit pass / 1 fail / 0 timeout / 26 skip**;
...
| 1.3 | **CIR coverage — drive `cir_node` (MC11-IR) → c2mir → MIR to full parity** | ongoing | **Active — the parity-to-master gate** (546 pass / 1 fail / 0 timeout / 26 skip on 2026-06-09 late; the ONE remaining red is `testfstream` — execution plan: [2026-06-10-testfstream-alias-reference-plan.md](2026-06-10-testfstream-alias-reference-plan.md); gcc-torture 1567/1685 = 93.0% vs asmjit 97.6%) | — |
