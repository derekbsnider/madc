...
- **CIR baseline (2026-06-01):** **450 integration pass / 13 fail / 55 skip**;
  **gcc.c-torture 1549/1685 (91.9%)** vs the old asmjit backend's 1645 (97.6%) — gap 96.
...
| 1.3 | **CIR coverage — drive `cir_node` (MC11-IR) → c2mir → MIR to full parity** | ongoing | **Active — the parity-to-master gate** (450 pass / 13 fail / 55 skip; gcc-torture 1549/1685 = 91.9% vs asmjit 97.6%) | — |
