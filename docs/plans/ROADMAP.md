...
`feature/simd-vector-support-codex` is at `fbb47f3`, not yet pinned by madc's
...
`/workspace/mir` `timeout 900 make test` passed with `Tests 1081, Success
tests 2162`, focused `interp-test17` and
