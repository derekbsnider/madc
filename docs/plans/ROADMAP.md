...
| 1.3 | **CIR coverage — drive `cir_node` (MC11-IR) → c2mir → MIR to full parity** | ongoing | **Active — the parity-to-master gate** (555 pass / 0 fail / 0 timeout / 20 skip on 2026-06-10 @ `7e84242` — ZERO integration reds; remaining parity work is the gcc-torture gap: 1567/1685 = 93.0% vs asmjit 97.6%, gap 78) | — |
