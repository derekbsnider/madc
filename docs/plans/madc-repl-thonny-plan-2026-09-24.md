...
- **Built (2026-09-26).**
  ...
  - **Next: slice 3.** A madc `var`, the containers (`std::string`, `std::vector`) and `ans` (D12). They show `<type>` until then.
