...
int main (void) {
  ...
  v1uti ti_c;
  v1uti ti_zero = {0};
  v1uti ti_div_a, ti_div_q, ti_div_r, ti_div_recomposed;
  v1ti tsi_a = {-8};
  v1ti tsi_b = {3};
  v1ti tsi_c;
  v1ti tsi_div_a, tsi_div_q, tsi_div_r, tsi_div_recomposed;
  ...
  *(v2di_attr_expr *) &alias_words[2] = alias_b;
  ...
  ti_c = (v1uti) {123} / (v1uti) {5};
  if (ti_c[0] != 24) return 255;
  ti_c = (v1uti) {123} % (v1uti) {5};
  if (ti_c[0] != 3) return 255;
  ti_c = (v1uti) {123};
  ti_c /= (v1uti) {5};
  if (ti_c[0] != 24) return 255;
  ti_c = (v1uti) {123};
  ...
  ti_div_a = (v1uti) {1};
  ti_div_a <<= 96;
  ti_div_a += (v1uti) {12345};
  ti_div_q = ti_div_a / (v1uti) {97};
  ti_div_r = ti_div_a % (v1uti) {97};
  ti_div_recomposed = ti_div_q * (v1uti) {97} + ti_div_r;
  if (ti_div_recomposed[0] != ti_div_a[0]) return 255;
  if (ti_div_r[0] >= 97) return 255;
  tsi_c = (v1ti) {-123} / (v1ti) {5};
  if (tsi_c[0] != -24) return 255;
  tsi_c = (v1ti) {-123} % (v1ti) {5};
  if (tsi_c[0] != -3) return 255;
  tsi_c = (v1ti) {-123};
  tsi_c /= (v1ti) {-6};
  if (tsi_c[0] != 20) return 255;
  tsi_c = (v1ti) {-123};
  tsi_c %= (v1ti) {5};
  if (tsi_c[0] != -3) return 255;
  tsi_div_a = (v1ti) {1};
  tsi_div_a <<= 92;
  tsi_div_a = -tsi_div_a;
  tsi_div_a -= (v1ti) {12345};
  tsi_div_q = tsi_div_a / (v1ti) {97};
  tsi_div_r = tsi_div_a % (v1ti) {97};
  tsi_div_recomposed = tsi_div_q * (v1ti) {97} + tsi_div_r;
  if (tsi_div_recomposed[0] != tsi_div_a[0]) return 255;
  if (tsi_div_r[0] > 0) return 255;
  ti_c = +ti_b;
