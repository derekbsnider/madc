...
#define STR_VAL(c) STR (c)
  ...
  /* The scalar converts below MERGE into the destination (bits above the
     ...
     gcc -O0 at identical instruction counts).  Break the dependency the way
     gcc and clang do: zero the destination first (pxor dst,dst).  The tied
     "r 0" F2D/D2F forms keep the bare encoding: dst==src is a REAL
  ...
  {MIR_VADDI8, "r 0 r", "66 Y 0F FC r0 R2", 0},   /* paddb r0,r2 */
  {MIR_VADDI8, "r 0 mv", "66 Y 0F FC r0 m2", 0},  /* paddb r0,m128 */
  {MIR_VADDI16, "r 0 r", "66 Y 0F FD r0 R2", 0},  /* paddw r0,r2 */
  ...
  {MIR_VSUBI8, "r 0 r", "66 Y 0F F8 r0 R2", 0},   /* psubb r0,r2 */
  {MIR_VSUBI8, "r 0 mv", "66 Y 0F F8 r0 m2", 0},  /* psubb r0,m128 */
  {MIR_VSUBI16, "r 0 r", "66 Y 0F F9 r0 R2", 0},  /* psubw r0,r2 */
...
#define IMULL(ICODE, ICODES)                                     \
  ...
  {MIR_VMULI32, "r 0 r", "66 Y 0F 38 40 r0 R2", 0},  /* pmulld r0,r2 */
  {MIR_VMULI32, "r 0 mv", "66 Y 0F 38 40 r0 m2", 0}, /* pmulld r0,m128 */
  ...
  {MIR_VLSHI32, "r 0 r", "66 Y 0F F2 r0 R2", 0},   /* pslld r0,r2 */
  {MIR_VLSHI32, "r 0 mv", "66 Y 0F F2 r0 m2", 0},  /* pslld r0,m128 */
  {MIR_VRSHI32, "r 0 r", "66 Y 0F E2 r0 R2", 0},   /* psrad r0,r2 */
  {MIR_VRSHI32, "r 0 mv", "66 Y 0F E2 r0 m2", 0},  /* psrad r0,m128 */
  {MIR_VURSHI32, "r 0 r", "66 Y 0F D2 r0 R2", 0},  /* psrld r0,r2 */
  {MIR_VURSHI32, "r 0 mv", "66 Y 0F D2 r0 m2", 0}, /* psrld r0,m128 */
  {MIR_VLSHI64, "r 0 r", "66 Y 0F F3 r0 R2", 0},   /* psllq r0,r2 */
  {MIR_VLSHI64, "r 0 mv", "66 Y 0F F3 r0 m2", 0},  /* psllq r0,m128 */
  {MIR_VURSHI64, "r 0 r", "66 Y 0F D3 r0 R2", 0},  /* psrlq r0,r2 */
  {MIR_VURSHI64, "r 0 mv", "66 Y 0F D3 r0 m2", 0}, /* psrlq r0,m128 */
  ...
  {MIR_VEQI16, "r 0 mv", "66 Y 0F 75 r0 m2", 0}, /* pcmpeqw r0,m128 */
  {MIR_VEQI32, "r 0 r", "66 Y 0F 76 r0 R2", 0},  /* pcmpeqd r0,r2 */
  {MIR_VEQI32, "r 0 mv", "66 Y 0F 76 r0 m2", 0}, /* pcmpeqd r0,m128 */
  {MIR_VEQI64, "r 0 r", "66 Y 0F 38 29 r0 R2", 0},  /* pcmpeqq r0,r2 */
  {MIR_VEQI64, "r 0 mv", "66 Y 0F 38 29 r0 m2", 0}, /* pcmpeqq r0,m128 */
  {MIR_VGTI8, "r 0 r", "66 Y 0F 64 r0 R2", 0},   /* pcmpgtb r0,r2 */
  {MIR_VGTI8, "r 0 mv", "66 Y 0F 64 r0 m2", 0},  /* pcmpgtb r0,m128 */
  {MIR_VGTI16, "r 0 r", "66 Y 0F 65 r0 R2", 0},  /* pcmpgtw r0,r2 */
